...
| [cursor](https://www.w3schools.com/cssref/pr_class_cursor.asp)                                                                                                   | chỉ định con trỏ chuột hiển thị khi đi qua một phần tử                                                                               | `auto` \| `alias` \| `all-scroll`<br>`cell` \| `context-menu` \| `col-resize`<br>`copy` \| `crosshair` \| `default`<br>`e-resize` \| `ew-resize` \| `grab`<br>`grabbing` \| `help`\| `move` \| `n-resize`<br> `ne-resize` \| `nesw-resize` \| `ns-resize` \| `nw-resize`<br>`nwse-resize` \| `no drop`\| `pointer`<br>`progress` \| `row-resize`\| `s-resize`<br>`se-resize` \| `sw-resize`\| `text` \| `vertical-text`<br>`w-resize`\| `wait` \| `zoom-in` \| `zoom-out`<br>*URL* |
