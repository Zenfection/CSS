...
- [background-\*](https://www.w3schools.com/cssref/css3_pr_background.asp) : `color` `image` `position` `size` `repeat` `origin` `clip` `attachment`
  ...
  | [clip](https://www.w3schools.com/cssref/css3_pr_background-clip.asp)                                                                        | khoảng cách của màu và hình ảnh                                                                                                      | `border-box`<br>`padding-box`<br>`content-box`                                                                                                                                                                                                                                                       |
...
| ----------------------------------------------------------------------------------- | ----------- |
| [caption-side](https://www.w3schools.com/cssref/pr_tab_caption-side.asp)            |             |
...
| [clear](https://www.w3schools.com/cssref/pr_class_clear.asp)                        |             |
| [clip](https://www.w3schools.com/cssref/pr_pos_clip.asp)                            |             |
...
| [content](https://www.w3schools.com/cssref/pr_gen_content.asp)                      |             |
| [counter-increment](https://www.w3schools.com/cssref/pr_gen_counter-increment.asp)  |             |
| [counter-reset](https://www.w3schools.com/cssref/pr_gen_counter-reset.asp)          |             |
