...
| ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| @font-feature-values                                                                | cho phép tác giả sử dụng tên thường trông `font-variant-alternate` cho tính năng kích hoạt khác nhau trong `OpenType`<br> | tham khảo [tại đây](http://developer.mozilla.org/en-US/docs/Web/CSS/@font-feature-values)                                    | Chrome, Opera         |
| font-variant-alternates                                                             | kiểm soát sử dụng các `glyphs` liên kết với tên thay thế xác định trong `@font-feature-values`                            | tham khảo [tại đây](http://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-alternates)                                 | Chrome,Opera          |
| font-language-override                                                              | kiểm soát sử dụng ngôn ngữ dành cho `glyphs` trong một kiểu chữ                                                           | tham khảo [tại đây]()                                                                                                        | Chrome, Opera, Safari |
...
| font-synthesis                                                                      | kiểm soát những mặt chữ bị thiếu (**bold** ,*italic*) có thể tổng hợp bởi `browser`                                       | tham khảo [tại đây](http://developer.mozilla.org/en-US/docs/Web/CSS/font-synthesis)                                          | Chrome, Opera         |
...
| font-variant-position                                                               | kiểm soát sử dụng các `glyphs` thay thế trên hoặc chỉ số dưới liên quan đến đường cơ sở của phông chữ                     | tham khảo [tại đây](http://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-position)                                   | chrome,opera          |
|                                                                                     |                                                                                                                           |                                                                                                                              |                       |